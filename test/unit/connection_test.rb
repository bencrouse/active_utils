...
class ConnectionTest < Test::Unit::TestCase
  ...
  def test_successful_put_request
    ActiveMerchant::Connection.http_class.any_instance.expects(:put).with('/tx.php', 'data', {}).returns(@ok)
    response = @connection.request(:put, 'data', {})
    assert_equal 'success', response.body
  end

  def test_successful_delete_request
    ActiveMerchant::Connection.http_class.any_instance.expects(:delete).with('/tx.php', {}).returns(@ok)
